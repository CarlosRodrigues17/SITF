...
if (isset($_POST['Utilizador'])) {
  ...
  $MM_redirectLoginSuccess = "../Paginas/DepoisLogin/AntesJogo/BoasVindas.php";
  $MM_redirectLoginFailed = "../Paginas/AntesLogin/Falha.php";
...
<div id="BarraLat_1">
  <table width="100%" border="0">
    <tr id="B_Home">
      <td scope="col"><a href="../Paginas/AntesLogin/Inicio.php" >Home</a></td>
    </tr>
    <tr id="B_SITF">
      <td><a href="../Paginas/AntesLogin/SITF.php">SITF</a></td>
    </tr>
    <tr id="B_Servicos">
      <td><a href="../Paginas/AntesLogin/Servicos.php">Servi&ccedil;os</a></td>
    </tr>
    <tr id="B_Contactos">
      <td><a href="../Paginas/AntesLogin/Contactos.php">Contactos</a></td>
    </tr>
  </table>
</div>  
<div id="DivisaoLat1"> </div>
<div id="BarraLogin">
<!-- TemplateBeginEditable name="FormEdit" -->
...
<div id="Conteudo"> 
	<div id="TextoCont"
  <p>&Eacute;s treinador de futebol? Queres ter ainda mais sucesso? Ent&atilde;o:</p>
  <p>Vem experimentar este sistema de apoio &agrave; decis&atilde;o, e vais sentir o sabor da gl&oacute;ria.</p>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  </div>
	</div>
