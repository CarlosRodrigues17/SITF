...
<ul id="MenuBar1" class="MenuBarVertical">
              <li><a href="../Paginas/DepoisLogin/AntesJogo/BoasVindas.php">Inicio</a></li>
<li><a class="MenuBarItemSubmenu" href="#">Minha Equipa</a>
  <ul>
    <li><a href="../Paginas/DepoisLogin/AntesJogo/Plantel.php">Plantel</a></li>
    <li><a href="../Paginas/DepoisLogin/AntesJogo/EstatisticasColectivasAJ.php">An&aacute;lise Colectiva</a></li>
    <li><a href="#">T&aacute;cticas</a></li>
  </ul>
</li>
      <li><a href="#" class="MenuBarItemSubmenu">Jogador</a>
        <ul>
          <li><a href="../Paginas/DepoisLogin/AntesJogo/PerfilJogador.php">Perfil</a></li>
          <li><a href="../Paginas/DepoisLogin/EstatisticasIndividuaisAntesJogoJogadorCampo.php" class="MenuBarItemSubmenu">An&aacute;lise Individual </a>
            <ul>
              ...
              <li><a href="../Paginas/DepoisLogin/AntesJogo/EstatisticaIndividualJC_AJ.php">Jogadores de Campo</a></li>
            </ul>
          </li>
</ul>
  </li>
      <li><a class="MenuBarItemSubmenu" href="#">Competi&ccedil;&atilde;o</a>
        <ul>
          ...
          <li><a href="../Paginas/DepoisLogin/AntesJogo/UltimoJogo.php">&Uacute;ltimo Jogo</a></li>
          <li><a href="#" class="MenuBarItemSubmenu">Clubes</a>
            <ul>
<li><a href="#">Info</a></li>
<li><a href="../Paginas/DepoisLogin/AntesJogo/PlantelAdversario.php">Plantel</a></li>
<li><a href="#">Estat&iacute;stica Colectiva</a></li>
      ...
      <li><a href="#" class="MenuBarItemSubmenu">Pr&oacute;ximo Advers&aacute;rio</a>
        <ul>
          <li><a href="../Paginas/DepoisLogin/AntesJogo/PlantelAdversario.php">Plantel</a></li>
          <li><a href="../Paginas/DepoisLogin/AntesJogo/EstatisticasColectivasAdversario_AJ.php">An&aacute;lise Colectiva</a></li>
          <li><a href="#" class="MenuBarItemSubmenu">Jogador</a>
            <ul>
<li><a href="../Paginas/DepoisLogin/AntesJogo/PerfilJogadorAdversario.php">Perfil</a></li>
<li><a href="../Paginas/DepoisLogin/AntesJogo/EstatisticaIndividualAdversarioGR_AJ.php">An&aacute;lise Individual </a></li>
</ul>
          </li>
...
<div id="BarraDivisaoHoriz">
	...
	<div id="Inserir"><a href="../Paginas/DepoisLogin/AntesJogo/Boas_Vindas.php">Inserir dados</a></div>
</div>
<!-- TemplateEndEditable -->
