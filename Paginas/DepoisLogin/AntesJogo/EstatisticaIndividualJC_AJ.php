...
//Query para obter Jogadores  de campo da equipa
mysql_select_db($database_localhost, $localhost);
$query_Diferente_de_GuardaRedes = "SELECT * FROM jogador WHERE Id_Clube = $identificacao AND Posicao NOT LIKE '%Guarda Redes%'";
...
<div id="Conteudo"> 
  <div id="ControlEstatisticas">
      ...
      <div id="LabGuardaRedes"> <a id="Verlink" href="EstatisticaIndividualGR_AJ.php">Ã‚Â»Ã‚Â» Ver EstatÃƒÂ­sticas de Guarda Redes</a>			     </div> 
     <div id="VerMaisEstatistica"><?php
     echo "<a id=Verlink href=EstatisticaIndividualJC_AJ2.php?IdJogador=$JogadorId>Mais EstatÃƒÂ­sticas(+) Ã‚Â»</a>";
     ?>
	 </div>
...
?>
  ...
  if($rows > 0) {
	  ...
	  $row_Diferente_de_GuardaRedes = mysql_fetch_assoc($GuardaRedes);
  }
?>
      </select>
    </form>
   ...
   <div id="ControlTabelaEstatistica1">
    ...
    <tr>
     <th width="83" id="CelTituloEstatistica" scope="row">Golos Marcados</th>
