...
<div id="Conteudo"> 
  <div id="ControlEstatisticas">
     ...
     <?php
     echo "<a id=Verlink href=EstatisticaIndividualJC_AJ2.php?IdJogador=$JogadorId>Ã‚Â« (-)Voltar AtrÃƒÂ¡s</a>";
	 ?>
     </div>
...
?>
   ...
   <div id="ControlTabelaEstatistica1">
    ...
    <tr>
      <th width="70%" id="CelTituloTotalMedia">Golos</th>
      <th width="30%" id="CelTituloTotalMedia">Marcados</td>
    </tr>
    <tr>
     <td width="70%" id="CelTituloEspe" scope="row">PÃƒÂ©</th>
     <td width="30%" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <td width="70%" id="CelTituloEspe" scope="row">CabeÃƒÂ§a</th>
     <td width="30%" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <th width="70%" id="CelTituloTotalMedia" scope="row">Total</th>
     <td width="30%" id="CelEstatistica">&nbsp;</td>
   </tr>
    <tr>
     <td width="70%" id="CelTituloEspe" scope="row">Canto</th>
     <td width="30%" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <td width="70%" id="CelTituloEspe" scope="row">Livre Directo</th>
     <td width="30%" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <td width="70%" id="CelTituloEspe" scope="row">Livre Indirecto</th>
     <td width="30%" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <td width="70%" id="CelTituloEspe" scope="row">Penaltie</th>
     <td width="30%" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <td width="70%" id="CelTituloEspe" scope="row">Bola corrida</th>
     <td width="30%" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <th width="70%" id="CelTituloTotalMedia" scope="row">Total</th>
    ...
    <tr>
     <th width="70%" id="CelTituloEstatistica" scope="row">Auto-Golos</th>
     <td width="30%" id="CelEstatistica">&nbsp;</td>
    </tr>
    </table>
     </div>
