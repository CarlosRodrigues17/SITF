...
//Query para obter Guarda-Redes da equipa
mysql_select_db($database_localhost, $localhost);
$query_GuardaRedes = "SELECT * FROM jogador WHERE Id_Clube = $Id_ProximoAdversario AND Posicao LIKE '%Guarda Redes%'";
$GuardaRedes = mysql_query($query_GuardaRedes, $localhost) or die(mysql_error());
$row_GuardaRedes = mysql_fetch_assoc($GuardaRedes);
$totalRows_GuardaRedes = mysql_num_rows($GuardaRedes);
...
if(empty($_POST["SelectJogador"])&&empty($_GET['IdJogador'])){
	$JogadorId = $row_GuardaRedes ['Id_Jogador'];
...
<div id="BarraDivisaoHoriz">
    ...
    <div id="Analise"><a href="../Paginas/DepoisLogin/AntesJogo/BoasVindas.php">Aná¡lise</a></div>
...
<div id="Conteudo"> 
  <div id="ControlEstatisticas">
      ...
      <div id="LabJogadorDecampo"> <a id="Verlink" href="EstatisticaIndividualAdversarioJC_AJ.php">Ã‚Â»Ã‚Â» Ver EstatÃƒÂ­sticas de Jogadores de Campo</a></div>
     <div id="VerMaisEstatistica">
     <?php
     echo "<a id=Verlink href=EstatisticaIndividualAdversarioGR_AJ3.php?IdJogador=$JogadorId>Mais EstatÃƒÂ­sticas(+) Ã‚Â»</a>";
     ?>
     </div>
 	 <div id="VerMenosEstatistica">
     <?php
     echo "<a id=Verlink href=EstatisticaIndividualAdversarioGR_AJ.php?IdJogador=$JogadorId>Ã‚Â« (-)Voltar AtrÃƒÂ¡s</a>";
	 ?>
     </div>
  	 <div id="ControlTabelaTitulo">
        ...
        <tr>
         <th colspan="5" scope="col" id="TabelaTitulo">Estatísticas de <?php echo $row_Jogador['Nome_Conhecido']; ?> na Liga</th>
        </tr>
       </table>
  	 </div> 
...
do {  
?>
   <option value="<?php echo $row_GuardaRedes['Id_Jogador']?>"><?php echo $row_GuardaRedes['Nome_Conhecido']?></option>
   <?php
} while ($row_GuardaRedes = mysql_fetch_assoc($GuardaRedes));
  $rows = mysql_num_rows($GuardaRedes);
  if($rows > 0) {
      mysql_data_seek($GuardaRedes, 0);
	  $row_GuardaRedes = mysql_fetch_assoc($GuardaRedes);
  }
?>
      </select>
...
<div id="ControlTabelaEstatistica1">
    ...
    <tr>
     <th width="83" id="CelTituloEstatistica" scope="row">Penalties Contra</th>
    ...
    <tr>
     <th width="83" id="CelTituloEstatistica" scope="row">Defesas</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <th width="83" id="CelTituloEspe" scope="row">Completas</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <th width="83" id="CelTituloEspe" scope="row">Incompletas</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <td width="83" id="CelTituloEspe1" scope="row">Para Adversario</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <td width="83" id="CelTituloEspe1" scope="row">Para defesa</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <td width="83" id="CelTituloEspe1" scope="row">Fora</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <th width="83" id="CelTituloEstatistica" scope="row">Pontapés de Baliza</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
     <th width="83" id="CelTituloEstatistica" scope="row">Saídas</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <th width="83" id="CelTituloEspe" scope="row">Pelo Ar</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <td width="83" id="CelTituloEspe1" scope="row">Certas</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <td width="83" id="CelTituloEspe1" scope="row">Erradas</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
     <tr>
     <th width="83" id="CelTituloEspe" scope="row">Pelo Chãoo</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
     <th width="83" id="CelTituloEstatistica" scope="row">Reposições</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <th width="83" id="CelTituloEspe" scope="row">Com o Pé</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
     ...
     <tr>
     <th width="83" id="CelTituloEspe" scope="row">Com a Mão</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
