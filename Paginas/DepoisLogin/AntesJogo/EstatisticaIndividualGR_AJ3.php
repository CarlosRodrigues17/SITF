...
<div id="Conteudo"> 
  <div id="ControlEstatisticas">
     ...
     <?php
     echo "<a id=Verlink href=EstatisticaIndividualGR_AJ2.php?IdJogador=$JogadorId>Ã‚Â« (-)Voltar AtrÃƒÂ¡s</a>";
	 ?>
     </div>
...
?>
   ...
   <div id="ControlTabelaEstatistica1">
    ...
    <tr>
     <td width="83" id="CelTituloEspe1" scope="row">PÃƒÂ©</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <td width="83" id="CelTituloEspe1" scope="row">CabeÃƒÂ§a</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
