...
mysql_select_db($database_localhost, $localhost);
$query_Guarda_Redes = "SELECT * FROM jogador INNER JOIN jogador_posicao ON jogador.Id_jogador = jogador_posicao.Id_jogador WHERE jogador_posicao.Sigla LIKE 'GR' AND Id_Clube = $identificacao GROUP BY Nome_Conhecido";
  ...
  <div id="ControlTabela">
    <table width="192" border="0" id="TabelaGR" name="TabelaGR">
      ...
      do {
		...
		$valor = $row_Guarda_Redes['Id_Jogador'];
		echo "<a id=Selecionavel href=PerfilJogador.php?id=$valor>";
    ...
    <table width="149" border="0" id="TabelaAva" name="TabelaAva">
      ...
      do {
      	echo "<tr>";
    	echo "<td align=center id=Listas>";
		$valor = $row_Avancados['Id_Jogador'];
		echo "<a id=Selecionavel href=PerfilJogador.php?id=$valor>";
