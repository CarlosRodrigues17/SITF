...
<div id="Conteudo"> 
  <div id="ControlEstatisticas">
     ...
     <?php
     echo "<a id=Verlink href=EstatisticaIndividualJC_AJ3.php?IdJogador=$JogadorId>Mais EstatÃƒÂ­sticas(+) Ã‚Â»</a>";
     ?>
     </div>
 	 <div id="VerMenosEstatistica">
     <?php
     echo "<a id=Verlink href=EstatisticaIndividualJC_AJ.php?IdJogador=$JogadorId>Ã‚Â« (-)Voltar AtrÃƒÂ¡s</a>";
	 ?>
     </div>
