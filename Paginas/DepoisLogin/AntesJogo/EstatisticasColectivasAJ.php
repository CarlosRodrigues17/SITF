...
<div id="Conteudo"> 
  ...
  <div id="VerMaisEstatistica"><a id="VerMaislink" href="EstatisticasColectivasAJ2.php">Mais Estatísticas(+) »»</a></div>
   ...
   <div id="ControlFiltros"> 
    ...
    <tr>
      ...
      <th width="30%" id="CelTituloTotalMedia">Total</td>
    </tr>
    <tr>
    ...
    <tr>
      <th width="70%" style="border:none"></th>
      <th width="30%" id="CelTituloTotalMedia">Média</td>
    </tr>
    <tr>
    ...
    <tr>
      <th width="70%" id="CelTituloEstatistica" scope="row">Média de Idades</td>
      <td width="30%" id="CelEstatistica">&nbsp;</td>
    </tr>
    	</table>
    </div>
    ...
    <tr>
     <td width="83" id="CelTituloEspe" scope="row">Marcados</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <td width="83" id="CelTituloEspe" scope="row">Sofridos</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
     <td width="83" id="CelTituloEspe" scope="row">Cometidas</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <td width="83" id="CelTituloEspe" scope="row">Sofridas</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
     <td width="83" id="CelTituloEspe" scope="row">Amarelos</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <td width="83" id="CelTituloEspe" scope="row">Vermelhos</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <td width="83" id="CelTituloEspe" scope="row">Vermelhos Dir.</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
     <td width="83" id="CelTituloEspe" scope="row">Certos</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
     <td width="83" id="CelTituloEspe" scope="row">Favor</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <td width="83" id="CelTituloEspe" scope="row">Contra</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
     <td width="83" id="CelTituloEspe" scope="row">Correctos</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
