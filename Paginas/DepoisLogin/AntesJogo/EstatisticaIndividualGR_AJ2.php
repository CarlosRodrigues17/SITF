...
<div id="Conteudo"> 
  <div id="ControlEstatisticas">
     ...
     <?php
     echo "<a id=Verlink href=EstatisticaIndividualGR_AJ3.php?IdJogador=$JogadorId>Mais EstatÃƒÂ­sticas(+) Ã‚Â»</a>";
     ?>
     </div>
 	 <div id="VerMenosEstatistica">
     <?php
     echo "<a id=Verlink href=EstatisticaIndividualGR_AJ.php?IdJogador=$JogadorId>Ã‚Â« (-)Voltar AtrÃƒÂ¡s</a>";
	 ?>
     </div>
...
<div id="ControlTabelaEstatistica1">
    ...
    <tr>
     <th width="83" id="CelTituloEstatistica" scope="row">PontapÃƒÂ©s de Baliza</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
     <th width="83" id="CelTituloEstatistica" scope="row">SaÃƒÂ­das</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
     ...
     <tr>
     <th width="83" id="CelTituloEspe" scope="row">Pelo ChÃƒÂ£o</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
     <th width="83" id="CelTituloEstatistica" scope="row">ReposiÃƒÂ§ÃƒÂµes</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <th width="83" id="CelTituloEspe" scope="row">Com o PÃƒÂ©</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
     ...
     <tr>
     <th width="83" id="CelTituloEspe" scope="row">Com a MÃƒÂ£o</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
