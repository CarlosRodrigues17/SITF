...
<div id="BarraDivisaoHoriz">
	<div id="AntesJogo"><a href="BoasVindas.php">Preparaçãoo Antes do Jogo</a></div>
...
<div id="Conteudo"> 
  <div id="ControlEstatisticas">
     ...
     <?php
     echo "<a id=Verlink href=EstatisticaIndividualAdversarioGR_AJ2.php?IdJogador=$JogadorId>Ã‚Â« (-)Voltar AtrÃƒÂ¡s</a>";
	 ?>
     </div>
...
?>
   ...
   <div id="ControlTabelaEstatistica1">
    ...
    <tr>
      <th width="83" id="CelTituloTotalMedia">Golos</th>
      <th width="63" id="CelTituloTotalMedia">Marcados</td>
      <th width="63" id="CelTituloTotalMedia">Sofridos</td>
    </tr>
    <tr>
     <td width="83" id="CelTituloEspe1" scope="row">Pé<td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <td width="83" id="CelTituloEspe1" scope="row">Cabeça</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <th width="83" id="CelTituloTotalMedia" scope="row">Total</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <td width="83" id="CelTituloEspe1" scope="row">Canto</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <td width="83" id="CelTituloEspe1" scope="row">Livre Directo</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <td width="83" id="CelTituloEspe1" scope="row">Livre Indirecto</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <td width="83" id="CelTituloEspe1" scope="row">Penaltie</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <td width="83" id="CelTituloEspe1" scope="row">Bola corrida</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
     <th width="83" id="CelTituloEstatistica" scope="row">Auto-Golos</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    </table>
