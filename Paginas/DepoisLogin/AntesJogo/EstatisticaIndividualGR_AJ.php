...
mysql_select_db($database_localhost, $localhost);
$query_GuardaRedes = "SELECT * FROM jogador WHERE Id_Clube = $identificacao AND Posicao LIKE '%Guarda Redes%'";
...
mysql_select_db($database_localhost, $localhost);
$query_Jogador = "SELECT * FROM jogador WHERE jogador.Id_Clube = $identificacao AND jogador.Id_Jogador = $JogadorId";
...
<div id="Conteudo"> 
  <div id="ControlEstatisticas">
      ...
      <div id="LabJogadorDecampo"> <a id="Verlink" href="EstatisticaIndividualJC_AJ.php">Ã‚Â»Ã‚Â» Ver EstatÃƒÂ­sticas de Jogadores de Campo</a></div>  
     <div id="VerMaisEstatistica"><?php
     echo "<a id=Verlink href=EstatisticaIndividualGR_AJ2.php?IdJogador=$JogadorId>Mais EstatÃƒÂ­sticas(+) Ã‚Â»</a>";
     ?>
	 </div>
...
?>
   ...
   <div id="ControlTabelaEstatistica1">
    ...
    <tr>
      ...
      <th width="30%" id="CelTituloTotalMedia">Total</th>
    </tr>
    <tr>
      <th width="70%" id="CelTituloEstatistica" scope="row">Minutos Jogados</th>
      <td width="30%" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
      <th width="70%" id="CelTituloEstatistica" scope="row">NÃ‚Âº Jogos Jogados</th>
      <td width="30%" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
      <td width="70%" id="CelTituloEspe" scope="row">Completos</td>
      <td width="30%" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
      <td width="70%" id="CelTituloEspe" scope="row">Incompletos</td>
      <td width="30%" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
      <td width="70%" id="CelTituloEspe" scope="row">Titular</td>
      <td width="30%" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
      <td width="70%" id="CelTituloEspe" scope="row">Suplente Utilizado</td>
      <td width="30%" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
      <td width="70%" id="CelTituloEspe" scope="row">Suplente n/utilizado</td>
      <td width="30%" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
      <td width="70%" id="CelTituloEspe" scope="row">VitÃƒÂ³rias</td>
      <td width="30%" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
     <td width="83" id="CelTituloEspe" scope="row">Sofridos</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <td width="83" id="CelTituloEspe" scope="row">Marcados</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
     <td width="83" id="CelTituloEspe" scope="row">Cometidas</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <td width="83" id="CelTituloEspe" scope="row">Sofridas</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <th width="83" id="CelTituloEstatistica" scope="row">CartÃƒÂµes</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
     <tr>
     <td width="83" id="CelTituloEspe" scope="row">Amarelos</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <td width="83" id="CelTituloEspe" scope="row">Vermelhos</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <td width="83" id="CelTituloEspe" scope="row">Vermelhos Dir.</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <th width="83" id="CelTituloEstatistica" scope="row">DistÃƒÂ¢ncia Percorrida</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    </table>
