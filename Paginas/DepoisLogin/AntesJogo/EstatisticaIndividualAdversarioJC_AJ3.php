...
<div id="Conteudo"> 
  <div id="ControlEstatisticas">
      ...
      <div id="LabGuardaRedes"> <a id="Verlink" href="EstatisticaIndividualAdversarioGR_AJ.php">»» Ver Estatísticas de Guarda Redes</a>			      </div>
     <div id="VerMaisEstatistica">
     <?php
     echo "<a id=Verlink href=EstatisticaIndividualAdversarioJC_AJ2.php?IdJogador=$JogadorId>Ã‚Â« (-)Voltar AtrÃƒÂ¡s</a>";
	 ?>
     </div>
