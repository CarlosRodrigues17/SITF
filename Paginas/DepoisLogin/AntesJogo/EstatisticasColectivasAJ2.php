...
<div id="Conteudo"> 
  ...
  <div id="VerMaisEstatistica"><a id="Verlink" href="EstatisticasColectivasAJ3.php">Mais Estatísticas(+) »»</a></div>
 <div id="VerMenosEstatistica"><a id="Verlink" href="EstatisticasColectivasAJ.php">«« (-)Voltar Atrás</a></div>
  	 <div id="ControlTabelaTitulo">
        ...
        <tr>
         <th colspan="5" scope="col" id="TabelaTitulo">Estatísticas da Equipa na Liga</th>
        </tr>
       </table>
  	 </div> 
   ...
   <div id="ControlTabelaEstatistica1">
    ...
    <tr>
     <td width="83" id="CelTituloEspe1" scope="row">Pé</th>
    ...
    <div id="ControlTabelaEstatistica2">
   	<table id="Tabela1" width="100%" border="0" cellspacing="0" cellpadding="0" >
    <tr>
      <th width="83" id="CelTituloTotalMedia">Penalties</th>
      <th width="63" id="CelTituloTotalMedia">Favor</td>
      <th width="63" id="CelTituloTotalMedia">Contra</td>
    </tr>
    <tr>
     <td width="83" id="CelTituloEspe1" scope="row">Convertidos</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <td width="83" id="CelTituloEspe1" scope="row">Defendidos</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <td width="83" id="CelTituloEspe1" scope="row">Falhados</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <th width="63" id="CelTituloTotalMedia">Média/Jogo</td>
    </tr>
    <tr>
     <th width="83" id="CelTituloEstatistica" scope="row">Remates efectuados</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <td width="83" id="CelTituloEspe" scope="row">Baliza</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <td width="83" id="CelTituloEspe" scope="row">Fora</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <td width="83" id="CelTituloEspe" scope="row">Ao poste</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <th width="83" id="CelTituloEstatistica" scope="row">Remates contra</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
     <td width="83" id="CelTituloEspe" scope="row">Poste</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    <tr>
     <td width="83" id="CelTituloEspe" scope="row">Errados</th>
     <td width="63" id="CelEstatistica">&nbsp;</td>
     <td width="63" id="CelEstatistica">&nbsp;</td>
    </tr>
    </table>
