...
<div id="Conteudo"> 
  <p>Bem-Vindo !</p>
  <p>O melhor sistema de apoio à tomada de decisão dos treinadores de Futebol, feito a pensar no sucesso!</p>
  <p>&nbsp;</p>
  <p>O objectivo deste sistema é suportar e auxiliar a tomada de decisão do treinador, fornecendo dados sobre a sua Equipa e os adversários. </p>
  <p>O Sistema recebe os dados do campo, armazena-os, trata-os e por fim fornece-os ao utilizador para que este os analise.</p>
  <p>A Aplicação apresenta dois tipos de análise: </p>
  <p> - Preparação para o Jogo </p>
  <p>- Análise do Jogo em Tempo Real </p>
	</div>
<!-- InstanceEndEditable -->
<div id="Rodape">
